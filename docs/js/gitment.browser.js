...
function renderComments(_ref2, instance) {
  ...
  if (error) {
    ...
    if (error === _constants.NOT_INITIALIZED_ERROR && user.login && user.login.toLowerCase() === instance.admin.toLowerCase()) {
...
function ajaxFactory(method) {
  return function (apiPath) {
    ...
    var base = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'https://github.houston.softwaregrp.net/api/v3';

    var req = new XMLHttpRequest();
    var token = '5f65eb36d303f24aa9dfda81afefe24231225b7f';
...
var Gitment = function () {
  _createClass(Gitment, [{
    ...
    key: 'loginLink',
    get: function get() {
      var oauthUri = 'https://github.houston.softwaregrp.net/login/oauth/authorize';
